...
{	?>
			<div class="rom-btm" style="background-color: white; padding-top: 30px; padding-bottom: 30px; border-radius: 20px;">
				...
				<div class="col-md-6 room-midle wow fadeInUp animated" data-wow-delay=".5s">
					...
					<h6 style="font-family: 'Secular One', sans-serif; color: black;">Package Type : <?php echo htmlentities($result->PackageType);?></h6><br>
					<p style="font-family: 'Secular One', sans-serif; color: black;"><b>Location :</b> <?php echo htmlentities($result->PackageLocation);?></p><br>
