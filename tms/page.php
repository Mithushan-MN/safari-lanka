...
<div class="banner">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="font-family: 'Fredoka One', cursive;" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"><font style="font-size: 60px">About Us</font></h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
